...
struct Transform {
	 ...
	 */
	const(float)[] getMatrix() return const {
		return m_matrix;
	}
	 ...
	 */
	ref Transform combine(Transform otherTransform) return {
	 ...
	 * Returns: this
	 */
	ref Transform translate(Vector2f offset) return {
	 ...
	 * Returns: this
	 */
	ref Transform translate(float x, float y) return {
		sfTransform m = getFromTransform(this);
	 ...
	 * Returns: this
	 */
	ref Transform rotate(float angle) return {
	 ...
	 * Returns: this
	 */
	ref Transform rotate(float angle, float centerX, float centerY) return {
		sfTransform m = getFromTransform(this);
	 ...
	 * Returns: this
	 */
	ref Transform rotate(float angle, Vector2f center) return {
		sfTransform m = getFromTransform(this);
	 ...
	 * Returns: this
	 */
	ref Transform scale(float scaleX, float scaleY) return {
		sfTransform m = getFromTransform(this);
	 ...
	 * Returns: this
	 */
	ref Transform scale(Vector2f factors) return {
		sfTransform m = getFromTransform(this);
	 ...
	 * Returns: this
	 */
	ref Transform scale(float scaleX, float scaleY, float centerX, float centerY) return {
	 ...
	 * Returns: this
	 */
	ref Transform scale(Vector2f factors, Vector2f center) return {
		sfTransform m = getFromTransform(this);
