...
class Ftp
{
    ...
    static class DirectoryResponse:Response
    {
        ...
        package this(sfFtpDirectoryResponse* FtpDirectoryResponce)
        {
            ...
            Directory =nudsfml.system.string.toString(sfFtpDirectoryResponse_getDirectory(FtpDirectoryResponce));
    ...
    static class ListingResponse:Response
    {
        ...
        package this(sfFtpListingResponse* FtpListingResponce)
        {
            ...
            {
                Filenames[i] =nudsfml.system.string.toString(sfFtpListingResponse_getName(FtpListingResponce,i));
            }
    ...
    static class Response
    {
        ...
        package this(Ftp.Response.Status status = Ftp.Response.Status.InvalidResponse, const(char)* message = "")
        {
            import nudsfml.system.string;
            FtpStatus = status;
            Message =nudsfml.system.string.toString(message);
        }
