...
class Http
{
    ...
    static class Response
    {
        ...
        string getBody() const
        {
            ...
            return nudsfml.system.string.toString(sfHttpResponse_getBody(sfPtrResponse));
        }
        ...
        {
            import nudsfml.system.string;
            return nudsfml.system.string.toString(sfHttpResponse_getField(sfPtrResponse, field.ptr, field.length));
        }
